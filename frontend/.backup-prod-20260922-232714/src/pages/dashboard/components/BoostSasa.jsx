    ...
    >
      ...
      <ul className="flex flex-col gap-1.5 w-full text-left">
        {benefits.map((b, i) => (
          <li
            key={i}
            className="text-secondary flex items-start gap-1.5 text-body-sm"
          >
            <TrendingUp
              size={12}
      ...
      >
        ...
        >
          ...
          {done.paidWith === "credits" && (
            <p className="text-body-sm text-[#2F6D4F] mb-4">
              {t(
              ...
              <>
                {selectedListing && isBoostActive(selectedListing) && (
                  <div
                    ...
                    className="flex flex-col items-center text-center gap-2 text-body-sm rounded-lg px-3 py-3 mb-4"
                  >
                    <Clock size={14} />
                ...
                >
                  <div>
                    <p
                      className="text-secondary text-body-sm mb-0.5"
                    >
