...
function MethodOption({ method, selected, onSelect }) {
  ...
  return (
    ...
    >
      ...
      <span
        className="text-primary text-sm font-medium flex-1 text-center"
      >
        {method.label}
      </span>
      <span
...
export default function PaymentGateway({
  ...
  if (step === "processing") {
    return (
      ...
      >
        ...
        />
        <p
          className="text-primary text-sm font-semibold mb-1.5"
        >
          {method.type === "mobile"
            ? lang === "sw"
  ...
  if (step === "success") {
    return (
      ...
      >
        ...
        <p
          className="text-secondary text-body-sm mb-5"
        >
          {formatTZS(amount)}{" "}
  ...
  return (
    ...
    >
      ...
      {description && (
        <p
          className="text-secondary text-body-sm mb-4 text-center"
        >
          {description}
        </p>
      )}
      ...
      <p
        className="text-primary text-body-sm font-semibold mb-2 text-center"
      >
      ...
      <p
        className="text-muted flex items-start justify-center gap-1.5 text-body-sm leading-snug text-center"
      >
