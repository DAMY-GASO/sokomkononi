    ...
    >
      ...
      {deal.reservationFee != null && (
        <div>
          ...
          <div
            style={{ borderColor: COLORS.sandLine }}
            className="flex flex-wrap gap-x-5 gap-y-1 bg-white border rounded-lg px-3 py-2.5 text-xs text-secondary"
          >
            <span>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{ borderColor: COLORS.sandLine }}
              className="text-xs font-semibold px-3 py-2 rounded-lg border text-secondary hover:bg-white transition-colors"
            >
