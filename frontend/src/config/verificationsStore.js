...
// ============================================================
// ASYNC ROLE ACTIONS — with rollback
// ============================================================
export async function addRoleAsync(role) {
  ...
  try {
    ...
    saveAll(STORAGE_KEY, UPDATE_EVENT, current); // Rollback
...
export async function updateRoleAsync(key, patch) {
  ...
  // System roles: ruhusu kubadilisha label/permissions tu, sio key
  ...
  // Local-only role (haijasync bado)
  ...
  try {
    ...
    saveAll(STORAGE_KEY, UPDATE_EVENT, previous); // Rollback
...
// ============================================================
// ASYNC STAFF ACTIONS — with rollback
// ============================================================
export async function addSubAdminAsync({ name, email, roleKey, userId }) {
  ...
  try {
    ...
    saveAll(SUBADMINS_KEY, SUBADMINS_EVENT, previous); // Rollback
