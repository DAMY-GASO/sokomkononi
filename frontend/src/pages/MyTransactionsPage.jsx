...
export default function MyTransactionsPage({ transactions: transactionsProp }) {
  // Ikiwa DashboardShell inatupatia transactions za kweli (zilizounganishwa na
  // Deal Rooms), tunazitumia. Vinginevyo (mf. wakati wa preview ya ukurasa huu
  // pekee) tunarudi kwenye mock data.
  const transactions = transactionsProp ?? SEED_TRANSACTIONS;
