  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5 mb-6">
      ...
      <div
        ...
        className="flex items-start gap-2 rounded-lg px-3 py-3 my-4 max-w-2xl mx-auto text-xs leading-relaxed"
      >
      ...
      <div
        ...
        className="text-center text-xs sm:text-sm font-medium rounded-lg px-4 py-3 mt-4 max-w-2xl mx-auto"
      >
        🎉{" "}
        {t(
