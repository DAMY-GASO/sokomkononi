        ...
        <>
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <button
              ...
              className="flex-1 text-xs font-semibold px-3 py-2 rounded-lg disabled:cursor-not-allowed"
            >
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2">
        {PAYMENT_METHODS.map((m) => (
          <button
            ...
            className="rounded-lg border px-2.5 py-2 text-xs font-medium text-center"
          >
            {m}
          </button>
        ))}
      ...
      <button
        ...
        className="text-xs font-semibold px-3 py-2.5 rounded-lg disabled:cursor-not-allowed"
      >
        {submitting
          ? lang === "sw"
            ? "Inatuma..."
            ...
            {selected === "custom" ? (
              <span className="flex items-center gap-1.5">
                <input
                  ...
                  style={{ borderColor: COLORS.sandLine, color: COLORS.night }}
                  className="w-16 rounded-md border px-2 py-1 text-xs outline-none text-center"
                />
                <span
                  style={{ color: "rgba(16,26,46,0.55)" }}
                  className="text-[11px]"
