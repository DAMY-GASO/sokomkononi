        ...
        >
          ...
          {request.notes && (
            <div className="min-w-0 w-full">
              ...
              <p className="text-xs text-gray-700 bg-white rounded-lg p-2.5 leading-relaxed break-words w-full">
                {request.notes}
              </p>
            </div>
          )}
            ...
            <div className="flex items-center gap-2 flex-wrap w-full min-w-0">
              ...
              {rejecting && (
                <button
                  ...
                  className="text-xs font-semibold px-3 py-2 rounded-lg text-gray-500 hover:bg-gray-100 transition-colors shrink-0"
                >
                  {t("Ghairi", "Cancel")}
                </button>
              )}
              ...
              <button
                ...
                className="ml-auto text-xs font-semibold px-2 py-2 rounded-lg text-gray-400 hover:text-[#C1502E] transition-colors shrink-0"
  ...
  return (
    <div className="w-full max-w-7xl mx-auto min-w-0 overflow-hidden">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-5 w-full">
        {[
          { label: t("Zote", "Total"), value: counts.total, color: COLORS.night },
