...
import { COLORS, FONTS, formatTZS, timeAgo } from "../../shared/constants.js";
...
function InfoRow({ icon: Icon, label, value, color = COLORS.night }) {
  return (
    <div className="flex items-start gap-2 text-xs">
      ...
      <span className="text-gray-800 font-medium min-w-0 break-words">
        {value}
      </span>
    </div>
  );
      ...
      {deal.disputeNote && (
        <div className="min-w-0">
          ...
          <p
            ...
            className="text-sm text-gray-700 bg-white border rounded-lg px-3 py-2.5 break-words"
          >
            {deal.disputeNote}
          </p>
        </div>
