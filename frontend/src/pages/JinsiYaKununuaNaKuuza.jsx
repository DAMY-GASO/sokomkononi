    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#101A2E] text-white py-12 sm:py-16 px-4 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mt-6">
          <a
            href="#kununua"
            className="bg-[#E8A33D] hover:bg-[#B87A1F] text-[#101A2E] font-semibold text-sm px-5 py-2.5 rounded-full transition-colors"
          >
            {t("Jinsi ya Kununua", "How to Buy")}
          </a>
          <a
            href="#kuuza"
            className="bg-[#2F6D4F] hover:bg-[#245a41] text-white font-semibold text-sm px-5 py-2.5 rounded-full transition-colors"
          >
      ...
      >
        ...
        <p className="text-sm text-gray-500 mt-3 mb-10 max-w-xl mx-auto leading-relaxed">
          {t(
        ...
        <div
          className="flex items-start gap-2 rounded-lg px-4 py-3 my-6 max-w-2xl mx-auto text-xs sm:text-sm leading-relaxed text-left"
        ...
        <button
          ...
          className="mt-8 bg-[#E8A33D] hover:bg-[#B87A1F] text-[#101A2E] font-bold text-base px-8 py-3.5 rounded-xl transition-all shadow-sm hover:shadow-md"
        >
      ...
      >
        ...
        <button
          ...
          className="mt-8 bg-[#2F6D4F] hover:bg-[#245a41] text-white font-bold text-base px-8 py-3.5 rounded-xl transition-all shadow-sm hover:shadow-md"
        >
          {t("Uza Sasa", "Sell Now")}
        </button>
      </section>
