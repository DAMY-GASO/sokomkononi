              ...
              <>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <label className="flex items-start gap-2.5 text-body-sm text-secondary leading-relaxed cursor-pointer">
                    ...
                    <span>
                      {t("auth_legal_prefix")}{" "}
                      <Link to="/sheria" className="underline hover:text-secondary">{t("footer_terms")}</Link>{" "}
                      {t("auth_legal_and")}{" "}
                      <Link to="/faragha" className="underline hover:text-secondary">{t("footer_privacy")}</Link>
                    </span>
                  </label>
