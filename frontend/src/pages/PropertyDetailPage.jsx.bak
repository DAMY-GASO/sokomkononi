        ...
        <>
          <div className="mb-3 p-3 rounded-xl bg-[#E8A33D]/10 border border-[#E8A33D]/30">
            ...
            {isReserved && property.reservedUntil && (
              <p className="text-body-sm text-[#8A5A16] mt-1">
...
export default function PropertyDetailPage() {
  ...
  // ============================================================
  // RETURN-TO-LOGIN — akiwa amerejea hapa baada ya kulogin (kupitia
  // "Wasiliana na Muuzaji" au "Jiunge na Waiting List"), fanya
  // hatua aliyokuwa akiitaka moja kwa moja bila kubonyeza tena.
  // ============================================================
  useEffect(() => {
    ...
    if (openContactModal || autoJoinWaitlist) {
      // Safisha state ili "back"/refresh isirudie hatua hii.
