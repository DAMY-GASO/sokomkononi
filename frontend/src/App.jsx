...
import SafetyPage from "./page/SafetyPage.jsx";
...
function HomePage() {
  ...
  // NOTE: hizi ni picha za muda (placeholder) kutoka LoremFlickr kwa ajili ya
  // development/demo tu. Kabla ya kuzindua live, badilisha na picha halisi za
  // mali zenu au picha za stock zenye leseni sahihi (si za bure kiholela).
  const categories = [
    { name: "Nyumba", count: "3,200+", icon: "house", img: "https://loremflickr.com/400/300/house,architecture" },
    { name: "Viwanja", count: "2,100+", icon: "land", img: "https://loremflickr.com/400/300/land,plot" },
    { name: "Magari", count: "2,800+", icon: "car", img: "https://loremflickr.com/400/300/car,sedan" },
    { name: "Pikipiki", count: "1,500+", icon: "moto", img: "https://loremflickr.com/400/300/motorcycle" },
    { name: "Mabasi", count: "800+", icon: "bus", img: "https://loremflickr.com/400/300/bus" },
    { name: "Mashine", count: "900+", icon: "gear", img: "https://loremflickr.com/400/300/bulldozer,excavator" },
    { name: "Samani", count: "1,200+", icon: "sofa", img: "https://loremflickr.com/400/300/furniture,sofa" },
    { name: "Vifaa vya Elektroniki", count: "2,000+", icon: "electronics", img: "https://loremflickr.com/400/300/desktop,computer" },
  ];
  ...
  const trendingImages = [
    "https://loremflickr.com/400/300/house,tanzania",
    "https://loremflickr.com/400/300/modern,villa",
    "https://loremflickr.com/400/300/apartment,building",
    "https://loremflickr.com/400/300/bungalow",
    "https://loremflickr.com/400/300/mansion",
    "https://loremflickr.com/400/300/modern,house",
  ];

  // Placeholder pia — badilisha na picha halisi za wateja wenye ushuhuda
  const testimonialAvatars = [
    "https://loremflickr.com/100/100/woman,portrait",
    "https://loremflickr.com/100/100/man,portrait",
    "https://loremflickr.com/100/100/woman,portrait,africa",
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <div className="relative">
              ...
              >
                {selectedLang === "sw" ? "Kategoria" : "Categories"}
            ...
            {trustLinks.map((l) => (
              <Link key={l.to} to={l.to} className="text-white/70 hover:text-white text-sm font-medium transition-colors">
                {selectedLang === "sw" ? l.label.sw : l.label.en}
              </Link>
            ))}
          </nav>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* App Download Touchpoint - Header (huelekeza kwenye Waitlist) */}
            <Link
              to="/waitlist"
              aria-label={selectedLang === "sw" ? "Pakua App" : "Get the App"}
              title={selectedLang === "sw" ? "Pakua App" : "Get the App"}
              className="flex items-center gap-1.5 text-white/60 hover:text-white transition-colors border border-white/15 rounded-md px-2 sm:px-2.5 py-1.5"
            >
              ...
              <span className="hidden lg:inline text-xs font-medium whitespace-nowrap">
                {selectedLang === "sw" ? "Pakua App" : "Get App"}
              </span>
            </Link>
      ...
      <div className={`fixed top-0 right-0 h-full w-72 max-w-[80%] bg-[#101A2E] z-50 transition-transform duration-300 ease-out ${menuOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <div className="pt-16 px-6">
          ...
          <nav className="flex flex-col gap-1">
            ...
            >
              <span>{selectedLang === "sw" ? "Kategoria" : "Categories"}</span>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-6">
            ...
            <Link to="/register?intent=sell" className="bg-[#2F6D4F] hover:bg-[#245a41] text-white font-semibold px-6 py-3 rounded-md transition-colors">
              {selectedLang === "sw" ? "Uza Mali" : "Sell Property"}
            </Link>
          </div>
          ...
          {[1,2,3,4,5,6].map((item, idx) => (
            <div key={item} className="min-w-[200px] sm:min-w-[240px] bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex-shrink-0 hover:shadow-md transition-shadow">
              <div className="h-40 bg-[#F5F3EC] overflow-hidden">
                <img
                  src={trendingImages[idx]}
                  alt="Nyumba ya Vyumba 3, Mbezi"
                  loading="lazy"
      ...
      <section className="py-12 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {categories.map((cat, index) => (
            <Link key={index} to={`/kategoria/${cat.name.toLowerCase()}`} className="bg-white rounded-lg overflow-hidden text-center border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1 group">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#F5F3EC] rounded-xl p-6">
            <img
              src={testimonialAvatars[0]}
              alt="Mary"
              loading="lazy"
              className="w-14 h-14 rounded-full object-cover mx-auto mb-4 border-2 border-white shadow-sm"
            />
