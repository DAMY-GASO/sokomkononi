            ...
            <div key={idx} className="min-w-[200px] sm:min-w-[240px] bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex-shrink-0 hover:shadow-md transition-shadow">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <span className="text-green-600 text-xs font-medium">● {selectedLang === "sw" ? "Inapatikana" : "Available"}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 px-1">
          {testimonials.map((t, index) => (
            <div key={index} className="min-w-[260px] sm:min-w-[300px] bg-[#F5F3EC] rounded-xl p-6 flex-shrink-0">
              <img
                src={t.avatar}
                alt={t.name}
                loading="lazy"
              ...
              />
              <p className="text-gray-700 text-sm leading-relaxed text-center">"{selectedLang === "sw" ? t.quote.sw : t.quote.en}"</p>
              <p className="text-[#E8A33D] font-semibold mt-3 text-sm text-center">— {t.name}, {t.region}</p>
            </div>
          ))}
        </div>
      </section>
