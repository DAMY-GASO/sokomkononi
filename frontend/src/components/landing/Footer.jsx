      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a href="#" className="text-white/40 hover:text-[#E8A33D] transition-colors text-xl">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link to="/blog" className="text-white/50 hover:text-white text-sm transition-colors">Blog</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="text-white font-semibold text-sm">
                {selectedLang === "sw" ? "Jiandikisha Kupata Taarifa" : "Subscribe to Newsletter"}
              </h4>
            ...
            <div className="flex w-full md:w-auto gap-2">
              ...
              <button className="bg-[#E8A33D] hover:bg-[#B87A1F] text-[#0D1524] font-semibold text-sm px-4 py-2 rounded-md transition-colors whitespace-nowrap">
                {selectedLang === "sw" ? "Jiandikisha" : "Subscribe"}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex flex-col-reverse md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-white/30 text-xs">
            <span>{selectedLang === "sw" ? "Malipo yanakubaliwa:" : "Payments accepted:"}</span>
