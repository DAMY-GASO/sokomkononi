      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link to="/kuhusu" className="text-white/50 hover:text-white text-sm transition-colors">
                  {selectedLang === "sw" ? "Kuhusu Mfumo" : "About System"}
                </Link>
              </li>
              <li>
                <Link to="/#matangazo" className="text-white/50 hover:text-white text-sm transition-colors">
                  {selectedLang === "sw" ? "Matangazo" : "Ads"}
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-2.5">
              <li>
                <Link to="/sheria" className="text-white/50 hover:text-white text-sm transition-colors">
                  {selectedLang === "sw" ? "Sheria na Masharti" : "Terms & Conditions"}
                </Link>
              </li>
              <li>
                <Link to="/faragha" className="text-white/50 hover:text-white text-sm transition-colors">
                  {selectedLang === "sw" ? "Sera ya Faragha" : "Privacy Policy"}
                </Link>
              </li>
              <li>
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-3">
              <li className="text-white/50 text-sm flex items-center justify-center lg:justify-start gap-2">
                ...
                <a href="mailto:support@sokomkononi.co.tz" className="hover:text-white transition-colors">
