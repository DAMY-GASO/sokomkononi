...
export default function AboutSafetyPage() {
  ...
  // ============================================================
  // TIPS — zinaundwa upya kila lugha inabadilika
  // ============================================================
  const tips = useMemo(
    () => [
      {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-14 px-4 max-w-3xl mx-auto text-center">
        <p className="text-secondary text-body leading-relaxed">{t("about_mission")}</p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {values.map((v, i) => (
            ...
            >
              ...
              <h3>{v.title}</h3>
              <p className="text-secondary text-body-sm mt-2">{v.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="usalama" className="py-14 px-4 max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-secondary text-body mt-2 max-w-xl mx-auto">
            {t("safety_subtext")}
          </p>
        </div>
          ...
          {tips.map((tip, i) => (
            <div key={i} className="p-6 bg-[#F5F3EC] rounded-xl">
              <div className="flex flex-col items-center text-center gap-3">
                ...
                <div>
                  <h3>{tip.title}</h3>
                  <p className="text-secondary text-body-sm mt-2">{tip.body}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-8 p-5 rounded-xl border-2 border-red-300 bg-red-50 flex flex-col items-center text-center gap-3">
          ...
          <div>
            ...
            <p className="text-red-700 text-body-sm leading-relaxed max-w-md mx-auto">
